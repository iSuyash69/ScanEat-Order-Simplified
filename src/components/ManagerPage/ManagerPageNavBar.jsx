    ...
    return(
        <div className="navBar-container navBar-container-cartPage manager-page-navbar">
            ...
            <div className="manager-page-routes">
                ...
                <Link style={{textDecoration:'none'}} to={"/updateItems"}><h4 className="routes-name r3" style={{fontWeight:'500',color:(liveOrders==true && dashboard==true)?'#fc8019':''}}>Update Items</h4></Link>
            </div>
